...
namespace Engine.OperatorEngine
{
    ...
    public class FuncArgument
    {
        ...
        // И в процедуре, хотя и можно определить, что произошла подстановка Места,
        ...
        public FuncArgument(string name, string type, string val, string queryValue)
        {
            this.m_argname = name;
            m_argtype = type;
            m_argvalue = val;
        ...
        /// </summary>
        /// <param name="p">Найденное Место</param>
